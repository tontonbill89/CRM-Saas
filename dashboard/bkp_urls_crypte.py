...
from . import formsclient, formsproduit, formsvisite, formsvente, formsuser, formsconfig, rapport, formsEquipeSecteurProfile
...
urlpatterns = [
    ...
    path('api/equipes/update/<int:pk>/', formsconfig.manage_secteur),
